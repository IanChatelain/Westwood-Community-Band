...
('media', 'Media', '/media', 'full', 25, '[
  {"id":"m1","type":"hero","title":"Photos, Recordings & Videos","content":"Browse photos from our concerts, listen to recordings, and watch videos of the Westwood Community Band.","imageUrl":"/images/media.jpg"},
  ...
  {"id":"m3","type":"text","title":"International Music Camp","content":"The <a href=\"http://www.internationalmusiccamp.com/\" target=\"_blank\" rel=\"noopener noreferrer\">International Music Camp</a> is an annual event for students and adults that takes place at the International Peace Gardens on the border between Manitoba and North Dakota."},
  {"id":"m4","type":"downloads","title":"Band Documents","content":"Download band resources including the complete music library listing.","downloadItems":[]}
]'::jsonb, true, 2, NULL),
('photos', 'Photos', '/photos', 'full', 25, '[
  ...
  {"id":"ph2","type":"gallery","title":"Event Photos","content":"","galleryColumns":3,"galleryCardSize":"md","galleryThumbnailAspect":"landscape","galleryShowDescription":true,"galleryEvents":[
